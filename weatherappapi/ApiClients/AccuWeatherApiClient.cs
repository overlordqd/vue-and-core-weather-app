...
{
    public class AccuWeatherApiClient : WeatherApiClientBase, IWeatherApiClient
    {
        private readonly AppSettings appSettings;
        private readonly IWeatherApiCallFactory weatherApiCallFactory;

        public IEnumerable<string> SupportedCalls => new[] { Types.Current, Types.Forecast, Types.LocationKey };

        public AccuWeatherApiClient(IAppSettingsWrapper appSettingsWrapper, IWeatherApiCallFactory weatherApiCallFactory)
        {
        ...
        private async Task<string> GetLocationKey(string cityName)
        {
            ...
            using var request = new HttpRequestMessage(HttpMethod.Get, ConstructRequestUrl(Types.LocationKey, cityName));
